                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    ...
                    <ul class="navbar-nav mr-auto mt-2 mt-lg-0-">
                        <li class="nav-item active">
                            <a id="index_menu" class="nav-link" href="#">Mentions légales<span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
                            <a id="table_menu" class="nav-link" href="#">Horraires</a>
                        </li>
                        <li class="nav-item">
                            <a id="formulaire_menu" class="nav-link" href="#">Plant du site</a>
                    </ul>
